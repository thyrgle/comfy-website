...
export function wasm_bindgen__convert__closures__invoke1_mut__h0df7472bd665bcbd(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hd389779f99d2ecfe(a: number, b: number): void;
